...
class RealAdultScraper {
  ...
  async getWorkingAdultVideos(): Promise<RealAdultVideo[]> {
    const videos: RealAdultVideo[] = [
      {
  ...
  async getDirectVideoUrl(siteUrl: string): Promise<string | null> {
    try {
  ...
  async scrapeFromAdultAPI(): Promise<RealAdultVideo[]> {
